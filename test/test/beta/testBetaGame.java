...
public class testBetaGame {
	...
	public void simulateValidDrawGame() throws HantoException {
		...
		try {
			assertEquals("Placing a sparrow at home as first move should return OK", MoveResult.OK, theGame.makeMove(firstBPiece.getType(),null,firstBCoord));
			assertEquals("The piece at home should be a blue piece", firstBPiece.getColor(), theGame.getPieceAt(home).getColor());
			assertEquals("The piece at home should be a sparrow.", firstBPiece.getType(), theGame.getPieceAt(home).getType());

			assertEquals("Placing a sparrow should return OK", MoveResult.OK, theGame.makeMove(firstRPiece.getType(),null,firstRCoord));
			assertEquals("The piece should be a red piece", firstRPiece.getColor(), theGame.getPieceAt(firstRCoord).getColor());
			assertEquals("The piece should be a sparrow.", firstRPiece.getType(), theGame.getPieceAt(firstRCoord).getType());

			assertEquals("Placing a butterfly should return OK", MoveResult.OK, theGame.makeMove(secondBPiece.getType(),null,secondBCoord));
			assertEquals("The piece should be a blue piece", secondBPiece.getColor(), theGame.getPieceAt(secondBCoord).getColor());
			assertEquals("The piece should be a butterfly.", secondBPiece.getType(), theGame.getPieceAt(secondBCoord).getType());
			
			assertEquals("Placing a sparrow should return OK", MoveResult.OK, theGame.makeMove(secondRPiece.getType(),null,secondRCoord));
			assertEquals("The piece should be a red piece", secondRPiece.getColor(), theGame.getPieceAt(secondRCoord).getColor());
			assertEquals("The piece should be a sparrow.", secondRPiece.getType(), theGame.getPieceAt(secondRCoord).getType());

			assertEquals("Placing a sparrow should return OK", MoveResult.OK, theGame.makeMove(thirdBPiece.getType(),null,thirdBCoord));
			assertEquals("The piece should be a blue piece", thirdBPiece.getColor(), theGame.getPieceAt(thirdBCoord).getColor());
			assertEquals("The piece should be a sparrow.", thirdBPiece.getType(), theGame.getPieceAt(thirdBCoord).getType());

			assertEquals("Placing a butterfly should return OK", MoveResult.OK, theGame.makeMove(thirdRPiece.getType(),null,thirdRCoord));
			assertEquals("The piece should be a red piece", thirdRPiece.getColor(), theGame.getPieceAt(thirdRCoord).getColor());
			assertEquals("The piece should be a butterfly.", thirdRPiece.getType(), theGame.getPieceAt(thirdRCoord).getType());

			assertEquals("Placing a sparrow should return OK", MoveResult.OK, theGame.makeMove(fourthBPiece.getType(),null,fourthBCoord));
			assertEquals("The piece should be a blue  piece", fourthBPiece.getColor(), theGame.getPieceAt(fourthBCoord).getColor());
			assertEquals("The piece should be a sparrow.", fourthBPiece.getType(), theGame.getPieceAt(fourthBCoord).getType());

			assertEquals("Placing a sparrow should return OK", MoveResult.OK, theGame.makeMove(fourthRPiece.getType(),null,fourthRCoord));
			assertEquals("The piece should be a red  piece", fourthRPiece.getColor(), theGame.getPieceAt(fourthRCoord).getColor());
			assertEquals("The piece should be a sparrow.", fourthRPiece.getType(), theGame.getPieceAt(fourthRCoord).getType());
			
			assertEquals("Placing a sparrow should return OK", MoveResult.OK, theGame.makeMove(fifthBPiece.getType(),null,fifthBCoord));
			assertEquals("The piece should be a blue  piece", fifthBPiece.getColor(), theGame.getPieceAt(fifthBCoord).getColor());
			assertEquals("The piece should be a sparrow.", fifthBPiece.getType(), theGame.getPieceAt(fifthBCoord).getType());
			
			assertEquals("Placing a sparrow should return OK", MoveResult.OK, theGame.makeMove(fifthRPiece.getType(),null,fifthRCoord));
			assertEquals("The piece should be a red  piece", fifthRPiece.getColor(), theGame.getPieceAt(fifthRCoord).getColor());
			assertEquals("The piece should be a sparrow.", fifthRPiece.getType(), theGame.getPieceAt(fifthRCoord).getType());

			assertEquals("Placing a sparrow should return OK", MoveResult.OK, theGame.makeMove(sixthBPiece.getType(),null,sixthBCoord));
			assertEquals("The piece should be a blue  piece", sixthBPiece.getColor(), theGame.getPieceAt(sixthBCoord).getColor());
			assertEquals("The piece should be a sparrow.", sixthBPiece.getType(), theGame.getPieceAt(sixthBCoord).getType());

			assertEquals("Placing a sparrow should return DRAW", MoveResult.DRAW, theGame.makeMove(sixthRPiece.getType(),null,sixthRCoord));
			assertEquals("The piece should be a red  piece", sixthRPiece.getColor(), theGame.getPieceAt(sixthRCoord).getColor());
			assertEquals("The piece should be a sparrow.", sixthRPiece.getType(), theGame.getPieceAt(sixthRCoord).getType());
	...
	public void simulateValidRedWinsGame() throws HantoException {
		...
		try {
			...
			assertEquals("Placing a sparrow should return RED_WINS", MoveResult.RED_WINS, theGame.makeMove(fourthBPiece.getType(),null,fourthBCoord));
	...
	public void simulateValidBlueWinsGame() throws HantoException {
		...
		try {
			...
			assertEquals("Placing a sparrow should return BLUE_WINS", MoveResult.BLUE_WINS, theGame.makeMove(fourthBPiece.getType(),null,fourthBCoord));
	...
	public void simulateValidBlueWinsGame2() throws HantoException {
		...
		try {
			...
			assertEquals("Placing a sparrow should return BLUE Wins", MoveResult.BLUE_WINS, theGame.makeMove(fourthBPiece.getType(),null,fourthBCoord));
